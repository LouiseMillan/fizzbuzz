...
// Part 5: Get a new list of explorers in node, if the score numbers is divisible by 3, I need a 
// new propery called trick, and the value assigned is FIZZ, if not the value should be the score itself.
// Score: 3, Trick: FIZZ.
// Score: 4, Trick: 4.
// Score: 5, Trick: 5.
...
// Part 6: Get a new list of explorers in node if the score number is divisible by 5, we need to 
// set a new property called trick and set the value BUZZ, if not this value should be just the score
//
